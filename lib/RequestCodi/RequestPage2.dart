...
class RequestPageForm extends StatefulWidget {
  @override
  _RequestPageFormState createState() => _RequestPageFormState();
}
...
class RequestPage2 extends StatefulWidget {
  ...
  @override
  _RequestPage2State createState() {
    print("2");
    return _RequestPage2State();
  }
}
...
class _RequestPage2State extends State<RequestPage2> {
  ...
  void getFromId(int index) async {
    MyClothing i = await MyClothingDatabase.getFromId(_index);
    setState(() {
      widget.chosenBase64 = i.clothingImgBase64;
    });
